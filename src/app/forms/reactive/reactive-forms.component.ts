...
export class ReactiveFormsComponent implements OnInit {
  ...
  private createForm() {
    this.form = new FormGroup({
      ...
      mycontrol: new FormControl(this.user.mycontrol)
    });
  }
  ...
  private createFormBuilder() {
    this.form = this.fb.group({
      ...
      email: [this.user.email, [Validators.required, Validators.email], this.existsEmail],
      country: [this.user.country, Validators.required],
      username: [this.user.username, [Validators.required, this.forbiddenNames.bind(this)]],
      languages: this.fb.array([]),
      mycontrol: [this.user.mycontrol, Validators.required]
    });
  }
